...
class EPAHandler implements Runnable {
	...
	public void run() {
		for(String line:lines){
			...
			document.addField( ZXGJParserHelper.fileTypeField,ZXGJParserHelper.FileTypeEnumEAP);
